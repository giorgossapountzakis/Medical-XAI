...
shap_values = explainer.shap_values(np.ones((1,20)), nsamples=50)
inds = top_preds[0]
axes[0,0].imshow(img)
axes[0,0].axis('off')
...
plt.savefig(path+'ShapleyKernelforgridsearched.png')
'''
...
e = shap.GradientExplainer((model1, model1.features[-1]), inputs)
shap_values,indexes = e.shap_values(to_explain, ranked_outputs=3, nsamples=1000)
